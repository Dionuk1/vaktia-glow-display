...
const STRINGS: Record<Lang, Dict> = {
  sq: {
    ...
    ramadan: "Ramazani 2027 & Countdown",
    ramadanSub: "Numërimi deri në 8 Shkurt 2027 (1448 H)",
    guide: "Si të falet namazi",
    guideSub: "Lexo librin PDF, abdesi, rekatet dhe hapat",
    new: "I RI",
    newF: "E RE",
    updated: "PËRDITËSUAR",
    soon: "SË SHPEJTI",
  ...
  en: {
    ...
    langsSub: "Shqip, English, Deutsch, Türkçe",
    ramadan: "Ramadan 2027 & Countdown",
    ramadanSub: "Countdown to 8 February 2027 (1448 H)",
    guide: "How to pray",
    guideSub: "Read the PDF book, wudu, rakats and steps",
    new: "NEW",
    newF: "NEW",
    updated: "UPDATED",
    soon: "SOON",
  ...
  de: {
    ...
    langsSub: "Shqip, English, Deutsch, Türkçe",
    ramadan: "Ramazan 2027",
    ramadanSub: "8.02.2027 (1448 H)",
    guide: "Wie man betet",
    guideSub: "PDF-Buch, Wudu, Rakat und Schritte",
    new: "NEU",
    newF: "NEU",
  ...
  tr: {
    ...
    guideSub: "PDF kitap, abdest, rekatlar ve adımlar",
    new: "YENİ",
    newF: "YENİ",
    updated: "GÜNCELLENDİ",
    soon: "YAKINDA",
